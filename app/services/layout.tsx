          ...
          <div className="grid grid-cols-2 gap-8 md:grid-cols-4 lg:grid-cols-5">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-gray-400">
                ...
                <li><Link href="/services/smartclass" className="hover:text-white">Materials Classification</Link></li>
                <li><Link href="/services/smartlink" className="hover:text-white">Supply Chain</Link></li>
              </ul>
            </div>
            <div>
